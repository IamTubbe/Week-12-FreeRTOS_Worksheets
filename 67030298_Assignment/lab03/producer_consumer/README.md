...
1. ในทดลองที่ 2 เกิดอะไรขึ้นกับ Queue?
    - เกิดสภาวะ "คอขวด" (Bottleneck) ครับ
    - Producer (ผู้ผลิต 4 คน) ทำงานเร็วกว่า Consumer (ผู้บริโภค 2 คน) ทำให้ Queue เต็ม (ใน Log คือ Queue Backlog: 10)
    - เมื่อ Queue เต็ม สินค้าที่ผลิตใหม่จึงถูก "Dropped" (ทิ้ง) ไปถึง 23 ชิ้น
2. ในทดลองที่ 3 ระบบทำงานเป็นอย่างไร?
    - ระบบจะเกิด คอขวดที่รุนแรงยิ่งกว่าเดิม
    - อัตราส่วน 3:1 แย่กว่า 4:2 (หรือ 2:1) ทำให้ Consumer 1 คนทำงานไม่ทันแน่นอน
    - คาดว่า Queue จะเต็มตลอดเวลา และจำนวน Products Dropped จะสูงที่สุด (สูงกว่า 23) และ Efficiency จะต่ำที่สุด (ต่ำกว่า 66.7%)
3. Load Balancer แจ้งเตือนเมื่อไหร่?
    - มันแจ้งเตือนเมื่อตรวจพบ HIGH LOAD DETECTED!
    - ในทางปฏิบัติคือ เมื่อมันเห็นว่า Queue Backlog (จำนวนของในคิว) มีค่าสูงมาก (ในภาพคือ 9 หรือ 10) ซึ่งหมายความว่า Consumer ทำงานไม่ทัน และมันจะแนะนำให้ Add more consumers (เพิ่ม Consumer) เพื่อมาช่วยระบายงาน
